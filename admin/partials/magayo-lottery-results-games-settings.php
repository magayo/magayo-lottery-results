	...
	<table class="form-table">
		...
		<tr>
			<td colspan="2">
				...
				<?php _e('A single API call allows you to retrieve the draw results for a single game. You have 10 API calls per month and you can <a href="http://www.magayo.com/lottery-feeds/wordpress-lottery-plugin/" target="_blank">easily upgrade to increase the number of API calls</a>.', $this->plugin_name); ?>
			</td>
		</tr>
		<tr>
			<td valign="top">
