...
The most likely reason is that you have exceeded your API limit. You can check your API usage in our API Area (https://www.magayo.com/api/) and you may like to consider upgrading your API plan by visiting http://www.magayo.com/lottery-feeds/wordpress-lottery-plugin/.
